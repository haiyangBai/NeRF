...
from raysampling import MonteCarloRaysampler, NDCMultinomialRaysampler, RayBundle
from pytorch3d.renderer.cameras import CamerasBase
from pytorch3d.renderer.implicit import sample_pdf
...
class ProbabilisticRaysampler(torch.nn.Module):
    ...
    def forward(self, input_ray_bundle, ray_weights, **kwargs,):    # -> RayBundle
        """
        Args:
